...
namespace Final_Project.Datalayer
{
    public class LabourDataLayer
    {
      ...
      public   string _connectionString = "Data Source=LAPTOP-8HB43P71\\SQLEXPRESS;Initial Catalog=HomeSurviceFinalYearProject;Integrated Security=True;Encrypt=False";
        // 1. GET All Labour Records
        public static  List<LabourMaster> GetAllLabours()
        {
            List<LabourMaster> labourList = new List<LabourMaster>();

            using (SqlConnection conn = new SqlConnection("Data Source=LAPTOP-8HB43P71\\SQLEXPRESS;Initial Catalog=HomeSurviceFinalYearProject;Integrated Security=True;Encrypt=False"))
            {
