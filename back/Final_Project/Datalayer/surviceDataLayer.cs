...
namespace FinalYearProject.DataLayer
{
    ...
    {
        public static string sqlconnectionstring = "Data Source=LAPTOP-8HB43P71\\SQLEXPRESS;Initial Catalog=HomeSurviceFinalYearProject;Integrated Security=True;Encrypt=False";
        ...
        public static List<SurvicesMaster> GetReaderDataFromQuery()
        {
            ...
            string strQuery = "SELECT [ServiceID],[ServiceName],[ServiceImage],[ServiceCost],[ServiceDiscount] FROM [dbo].[Survices]";
        ...
        public static List<SurvicesMaster> GetSurviceInformationById(string ServiceID)
        {
            ...
            string strQuery = "SELECT [ServiceID],[ServiceName],[ServiceImage],[ServiceCost],[ServiceDiscount] FROM [dbo].[Survices] WHERE ServiceID = @ServiceID";
